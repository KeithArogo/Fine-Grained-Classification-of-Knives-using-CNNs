...
def evaluate(val_loader, model, criterion, epoch, train_loss, start):
    ...
    return [map.avg, filtered_metrics]
...
class CustomCNN(nn.Module):
    def __init__(self, num_classes=192):
        ...
        self.fc1 = nn.Linear(128 * 28 * 28, 512)  # Adjust the input features here
...
# Replace 'tf_efficientnet_b4' with 'tf_efficientnetv2_s' for EfficientNetV2-S
